      ...
      <div class="card p-fluid">
        ...
        <div class="p-fluid formgrid grid">
          <div class="field col-12 md:col-6">
            <label for="epName">名字</label>
            <InputText id="epName" type="text" />
          </div>
          <div class="field col-12 md:col-6">
            <label for="epLocation">地址</label>
            <InputText id="epLocation" type="text" />
          </div>
          <div class="field col-12 md:col-6">
            <label for="epType">类型</label>
            <InputText id="epType" type="text" />
          </div>
          <div class="field col-12 md:col-6">
            <label for="epPhonePerson">联系人</label>
            <InputText id="epPhonePerson" type="text" />
          </div>
          <div class="field col-12 md:col-6">
            <label for="epPhone">联系方式</label>
            <InputText id="epPhone" type="text" />
          </div>
        </div>
      </div>
